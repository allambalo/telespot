	...
	<body>
		<aside class="aside aside-fixed">
			<div class="aside-header">
				<a href="../../index.html" class="aside-logo">Tele<span>Spot</span></a>
				...
				<div class="container pd-x-0">
					<div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
						<div>
							...
							<h4 class="mg-b-0 tx-spacing--1">Добро пожаловать</h4>
						</div>
						<div class="d-none d-md-block">
							<a href="#modal2" data-toggle="modal" class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5"><i data-feather="file" class="wd-10 mg-r-5"></i> Добавить рассылку</a>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                  <div class="modal-content tx-14">
                                    <div class="modal-header">
                                      <h6 class="modal-title" id="exampleModalLabel2">Добавление рассылки</h6>
